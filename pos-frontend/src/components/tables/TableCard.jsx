...
import { useQueryClient } from '@tanstack/react-query'; // Import the hook
...
const TableCard = ({ id, name, status, initials, seats }) => {
    ...
    const handleFree = async (tableId) => {
        try {
            ...
            // ❌ This is not enough on its own since React Query is managing the data
            // dispatch(updateTable({ tableId: tableId, status: "Available" }));

            // ✅ Invalidate the 'tables' query to trigger a re-fetch
