...
export const getUserDataById = (id) =>
  axiosWrapper.get(`/api/user/getUser/${id}`);
...
export const getOrdersCount = () =>
  axiosWrapper.get("/api/order/get/getOrdersCount");
export const getCustomerCount = () =>
  axiosWrapper.get("/api/order/get/getCustomerCount");
export const getOrdersByEmployee = (employeeId) =>
